...
public class Rating
{
	public static int doRate(Element element){
		...
		//计算得分
		s = br_size * Properties.BRSecore + p_size * Properties.PSecore + chCharacter * Properties.CNCHARSCORE + chPunctuationCharacter * Properties.CNPNCHARSCORE + otherCharacter/5;
	...
	public static int doOwnTextRate(Element element){
		...
		//计算得分
		s = chCharacter * Properties.CNCHARSCORE + chPunctuationCharacter * Properties.CNPNCHARSCORE + otherCharacter/5;
